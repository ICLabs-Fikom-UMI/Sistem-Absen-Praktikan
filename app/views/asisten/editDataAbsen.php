    <div class="body-edit">
        <div class="container  d-flex justify-content-center align-items-center">
            <div class="content-beranda mt-5 lebar-edit">
                ...
                <form  class="mt-5" method="post" action="<?= BASEURL; ?>/Asisten/updateData">
                    ...
                    <?php endforeach; ?>
                        ...
                        <div class="modal-footer jarak-3 mt-5 m-4">
                            <a class="btn button-simpan-2 bg-primary rounded-4  jenis-font-label" style="background-color: red; text-decoration: none; color: white;" href="<?= BASEURL; ?>/Asisten/Kehadiran">Batal</a>
